...
def test_enriched_registered_model_from_uc_proto():
    expected_registered_model = RegisteredModel(
    ...
    assert enriched_registered_model_from_uc_proto(uc_proto) == expected_registered_model


def test_enriched_model_version_from_uc_proto():
    expected_model_version = ModelVersion(
    ...
    assert enriched_model_version_from_uc_proto(uc_proto) == expected_model_version


def test_enriched_registered_model_search_from_uc_proto():
    expected_registered_model = RegisteredModelSearch(
        name="catalog.schema.name",
        creation_timestamp=1,
        last_updated_timestamp=2,
    ...
    assert enriched_registered_model_search_from_uc_proto(uc_proto) == expected_registered_model


def test_enriched_model_version_search_from_uc_proto():
    expected_model_version = ModelVersionSearch(
        name="catalog.schema.model",
        version="3",
        creation_timestamp=1,
    ...
    assert enriched_model_version_search_from_uc_proto(uc_proto) == expected_model_version

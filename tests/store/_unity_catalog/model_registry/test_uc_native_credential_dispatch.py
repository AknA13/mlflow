...
# ---------------------------------------------------------------------------
def test_enriched_model_version_params_metrics_deployment():
    ...
    mv = enriched_model_version_from_uc_proto(proto)
...
def test_enriched_model_version_empty_enrichment():
...
def test_enriched_registered_model_deployment_fields():
    ...
    rm = enriched_registered_model_from_uc_proto(proto)
